...
LEXERS = {
    ...
    'GherkinLexer': ('pip._vendor.pygments.lexers.app_test', 'Gherkin', ('gherkin', 'cucumber'), ('*.feature',), ('text/x-gherkin',)),
    ...
    'TAPLexer': ('pip._vendor.pygments.lexers.app_test', 'TAP', ('tap',), ('*.tap',), ()),
